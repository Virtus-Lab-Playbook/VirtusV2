...
export function FinalCta() {
  return (
    ...
    >
      <Container>
        <div data-reveal className="max-w-[64rem]">
          <span className="font-mono text-[0.7rem] font-medium uppercase tracking-[0.14em] text-deep-2">
            {site.finalCta.eyebrow}
          </span>

          <p className="mt-6 max-w-[14ch] font-display text-[clamp(3rem,7vw,7.2rem)] leading-[0.94] tracking-[-0.035em] text-abyss">
            {site.finalCta.line}
          </p>

          <p className="mt-3 font-display text-[clamp(2.1rem,4vw,4.4rem)] italic leading-[1] text-deep-2">
